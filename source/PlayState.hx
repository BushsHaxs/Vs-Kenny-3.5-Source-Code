...
class PlayState extends MusicBeatState
{
	...
	var niebla:FlxSprite;
	var nieblaHUD:FlxSprite;
	var white:FlxSprite;
	var techoSky1:FlxSprite;
	var techoSky2:FlxSprite;
	var techoClouds1:FlxSprite;
	var techoClouds2:FlxSprite;
	var techoPosts:FlxSprite;
	var techoFloor1:FlxSprite;
	var techoFloor2:FlxSprite;
	var techoFront1:FlxSprite;
	var techoFront2:FlxSprite;
	var daSign:FlxSprite;
	var killNotesLag:FlxSprite;
	...
	var kyleJumpScare:FlxSprite;
	var stanJumpScare:FlxSprite;
	var kennyJumpScare:FlxSprite;
	var balling:FlxSprite;

	//mojon
	var sceneChristmas:FlxSprite;
	var shit:FlxSprite;
	var snow:FlxSprite;
	...
	override public function create()
	{
		...
		if (FlxG.save.data.noteSpaches)
		{
				var preloadidk:FlxSprite = new FlxSprite(-500, -100).loadGraphic(Paths.image('noteSplashes', 'preload'));
				var preloadidk2:FlxSprite = new FlxSprite(-500, -100).loadGraphic(Paths.image('NOTE_splashes_Mysterion', 'preload'));
				var preloadidk3:FlxSprite = new FlxSprite(-500, -100).loadGraphic(Paths.image('NOTE_splashes_Blood', 'preload'));
		...
		switch (curStage)
		{
			...
			case 'chips':
			{
					...
					var busCapa0:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop day 0'));
					busCapa0.setGraphicSize(Std.int(busCapa0.width * 0.9));
					busCapa0.updateHitbox();
					busCapa0.screenCenter(X);
					busCapa0.antialiasing = ClientPrefs.globalAntialiasing;
					busCapa0.scrollFactor.set(0.95, 0.95);
					busCapa0.active = false;
					add(busCapa0);

					var busCapa1:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop day 1'));
					busCapa1.setGraphicSize(Std.int(busCapa1.width * 0.9));
					busCapa1.updateHitbox();
					busCapa1.screenCenter(X);
					busCapa1.antialiasing = ClientPrefs.globalAntialiasing;
					busCapa1.scrollFactor.set(0.9, 0.94);
					busCapa1.active = false;
					add(busCapa1);

					var busCapa2:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop day 2'));
					busCapa2.setGraphicSize(Std.int(busCapa2.width * 0.9));
					busCapa2.updateHitbox();
					busCapa2.screenCenter(X);
					busCapa2.antialiasing = ClientPrefs.globalAntialiasing;
					busCapa2.scrollFactor.set(0.92, 0.94);
					busCapa2.active = false;
					add(busCapa2);

					var busCapa3:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop day 3'));
					busCapa3.setGraphicSize(Std.int(busCapa3.width * 0.9));
					busCapa3.updateHitbox();
					busCapa3.screenCenter(X);
					busCapa3.antialiasing = ClientPrefs.globalAntialiasing;
					busCapa3.scrollFactor.set(0.94, 0.95);
					busCapa3.active = false;
					add(busCapa3);
			}
			case 'hot-dog':
			{
					...
					var busCapa0:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop medio 0'));
					busCapa0.setGraphicSize(Std.int(busCapa0.width * 0.9));
					busCapa0.updateHitbox();
					busCapa0.screenCenter(X);
					busCapa0.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa1:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop medio 1'));
					busCapa1.setGraphicSize(Std.int(busCapa1.width * 0.9));
					busCapa1.updateHitbox();
					busCapa1.screenCenter(X);
					busCapa1.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa2:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop medio 2'));
					busCapa2.setGraphicSize(Std.int(busCapa2.width * 0.9));
					busCapa2.updateHitbox();
					busCapa2.screenCenter(X);
					busCapa2.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa3:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop medio 3'));
					busCapa3.setGraphicSize(Std.int(busCapa3.width * 0.9));
					busCapa3.updateHitbox();
					busCapa3.screenCenter(X);
					busCapa3.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'nugget':
			{
					...
					var busCapa0:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop casi medio capa 3'));
					busCapa0.setGraphicSize(Std.int(busCapa0.width * 0.9));
					busCapa0.updateHitbox();
					busCapa0.screenCenter(X);
					busCapa0.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa1:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop casi medio capa 2'));
					busCapa1.setGraphicSize(Std.int(busCapa1.width * 0.9));
					busCapa1.updateHitbox();
					busCapa1.screenCenter(X);
					busCapa1.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa2:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop casi medio capa 1'));
					busCapa2.setGraphicSize(Std.int(busCapa2.width * 0.9));
					busCapa2.updateHitbox();
					busCapa2.screenCenter(X);
					busCapa2.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa3:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop casi medio capa 0'));
					busCapa3.setGraphicSize(Std.int(busCapa3.width * 0.9));
					busCapa3.updateHitbox();
					busCapa3.screenCenter(X);
					busCapa3.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'burger':
			{
					...
					var busCapa0:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop capa 0'));
					busCapa0.setGraphicSize(Std.int(busCapa0.width * 0.9));
					busCapa0.updateHitbox();
					busCapa0.screenCenter(X);
					busCapa0.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa1:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop capa 1'));
					busCapa1.setGraphicSize(Std.int(busCapa1.width * 0.9));
					busCapa1.updateHitbox();
					busCapa1.screenCenter(X);
					busCapa1.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa2:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop capa 2'));
					busCapa2.setGraphicSize(Std.int(busCapa2.width * 0.9));
					busCapa2.updateHitbox();
					busCapa2.screenCenter(X);
					busCapa2.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa3:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/bustop capa 3'));
					busCapa3.setGraphicSize(Std.int(busCapa3.width * 0.9));
					busCapa3.updateHitbox();
					busCapa3.screenCenter(X);
					busCapa3.antialiasing = ClientPrefs.globalAntialiasing;
			...
			case 'pizza':
			{
					...
					techoSky1 = new FlxSprite(0, 0).loadGraphic(Paths.image('weeb/techoSky1'));
					techoSky1.setGraphicSize(Std.int(techoSky1.width * 0.9));
					techoSky1.updateHitbox();
					techoSky1.screenCenter(X);
					techoSky1.antialiasing = ClientPrefs.globalAntialiasing;
					techoSky1.scrollFactor.set(0.95, 0.95);
					techoSky1.active = false;
					add(techoSky1);

					techoSky2 = new FlxSprite(0, 0).loadGraphic(Paths.image('weeb/techoSky2'));
					techoSky2.setGraphicSize(Std.int(techoSky2.width * 0.9));
					techoSky2.updateHitbox();
					techoSky2.screenCenter(X);
					techoSky2.antialiasing = ClientPrefs.globalAntialiasing;
					techoSky2.scrollFactor.set(0.95, 0.95);
					techoSky2.active = false;

					techoClouds1 = new FlxSprite(0, 0).loadGraphic(Paths.image('weeb/techoClouds1'));
					techoClouds1.setGraphicSize(Std.int(techoClouds1.width * 0.9));
					techoClouds1.updateHitbox();
					techoClouds1.screenCenter(X);
					techoClouds1.antialiasing = ClientPrefs.globalAntialiasing;
					techoClouds1.scrollFactor.set(0.92, 0.94);
					techoClouds1.active = false;
					add(techoClouds1);

					techoClouds2 = new FlxSprite(0, 0).loadGraphic(Paths.image('weeb/techoClouds2'));
					techoClouds2.setGraphicSize(Std.int(techoClouds2.width * 0.9));
					techoClouds2.updateHitbox();
					techoClouds2.screenCenter(X);
					techoClouds2.antialiasing = ClientPrefs.globalAntialiasing;
					techoClouds2.scrollFactor.set(0.92, 0.94);
					techoClouds2.active = false;

					techoPosts = new FlxSprite(0, 40).loadGraphic(Paths.image('weeb/techoPosts'));
					techoPosts.setGraphicSize(Std.int(techoPosts.width * 0.9));
					techoPosts.updateHitbox();
					techoPosts.screenCenter(X);
					techoPosts.antialiasing = ClientPrefs.globalAntialiasing;
					techoPosts.scrollFactor.set(0.9, 0.94);
					techoPosts.active = false;
					add(techoPosts);

					techoFloor1 = new FlxSprite(0, 80).loadGraphic(Paths.image('weeb/techoFloor1'));
					techoFloor1.setGraphicSize(Std.int(techoFloor1.width * 0.9));
					techoFloor1.updateHitbox();
					techoFloor1.screenCenter(X);
					techoFloor1.antialiasing = ClientPrefs.globalAntialiasing;
					techoFloor1.scrollFactor.set(0.94, 0.95);
					techoFloor1.active = false;
					add(techoFloor1);

					techoFloor2 = new FlxSprite(0, 80).loadGraphic(Paths.image('weeb/techoFloor2'));
					techoFloor2.setGraphicSize(Std.int(techoFloor2.width * 0.9));
					techoFloor2.updateHitbox();
					techoFloor2.screenCenter(X);
					techoFloor2.antialiasing = ClientPrefs.globalAntialiasing;
					techoFloor2.scrollFactor.set(0.94, 0.95);
					techoFloor2.active = false;

					techoFront1 = new FlxSprite(0, 100).loadGraphic(Paths.image('weeb/techoFront1'));
					techoFront1.setGraphicSize(Std.int(techoFront1.width * 0.9));
					techoFront1.updateHitbox();
					techoFront1.screenCenter(X);
					techoFront1.antialiasing = ClientPrefs.globalAntialiasing;
					techoFront1.scrollFactor.set(0.935, 0.92);
					techoFront1.active = false;

					techoFront2 = new FlxSprite(0, 100).loadGraphic(Paths.image('weeb/techoFront2'));
					techoFront2.setGraphicSize(Std.int(techoFront2.width * 0.9));
					techoFront2.updateHitbox();
					techoFront2.screenCenter(X);
					techoFront2.antialiasing = ClientPrefs.globalAntialiasing;
					techoFront2.scrollFactor.set(0.935, 0.92);
					techoFront2.active = false;

					lluvia = new FlxSprite(0, 0);
					lluvia.frames = Paths.getSparrowAtlas('weeb/rain');
					lluvia.animation.addByPrefix('idle', "rain", 30);
					lluvia.antialiasing = true;
					lluvia.screenCenter();
					lluvia.scrollFactor.set(0.8, 0.8);
					lluvia.setGraphicSize(Std.int(lluvia.width * 1));
			...
			case 'southpurgation':
			{
					defaultCamZoom = 0.7;
					curStage = 'sos';
					var skyZ:FlxSprite = new FlxSprite(-1090, -850).loadGraphic(Paths.image('weeb/skyKNZ'));
					skyZ.setGraphicSize(Std.int(skyZ.width * 1));
					skyZ.antialiasing = ClientPrefs.globalAntialiasing;
					skyZ.scrollFactor.set(0.95, 0.95);
					skyZ.active = false;
					add(skyZ);

					var moutainsZ:FlxSprite = new FlxSprite(-800, 140).loadGraphic(Paths.image('weeb/moutainsKNZ'));
					moutainsZ.setGraphicSize(Std.int(moutainsZ.width * 1.1));
					moutainsZ.updateHitbox();
					moutainsZ.antialiasing = ClientPrefs.globalAntialiasing;
					moutainsZ.scrollFactor.set(0.9, 0.9);
					moutainsZ.active = false;
					add(moutainsZ);

					var graveyardZ:FlxSprite = new FlxSprite(-720, -320).loadGraphic(Paths.image('weeb/cementerioKNZ'));
					graveyardZ.setGraphicSize(Std.int(graveyardZ.width * 1.2));
					graveyardZ.updateHitbox();
					graveyardZ.antialiasing = ClientPrefs.globalAntialiasing;
					graveyardZ.scrollFactor.set(0.95, 0.95);
					graveyardZ.active = false;
					add(graveyardZ);

					niebla = new FlxSprite(0, 0);
					niebla.frames = Paths.getSparrowAtlas('weeb/fog');
					niebla.setGraphicSize(Std.int(niebla.width * 2));
					niebla.animation.addByPrefix('idle', "nieblal", 30);
					niebla.screenCenter();
					niebla.animation.play('idle');
					niebla.scrollFactor.set(0.95, 0.95);
					niebla.alpha = 1;
					add(niebla);

					nieblaHUD = new FlxSprite(0, 0);
					nieblaHUD.frames = Paths.getSparrowAtlas('weeb/fog');
					nieblaHUD.setGraphicSize(Std.int(nieblaHUD.width * 1));
					nieblaHUD.animation.addByPrefix('idle', "nieblal", 30);
					nieblaHUD.screenCenter();
					nieblaHUD.animation.play('idle');
					nieblaHUD.scrollFactor.set(0.95, 0.95);
					nieblaHUD.alpha = 0.8;
					nieblaHUD.flipX = true;

					killNotesLag = new FlxSprite(0, 0);
					killNotesLag.frames = Paths.getSparrowAtlas('kill');
					killNotesLag.animation.addByPrefix('A', "A", 24);
					killNotesLag.animation.addByPrefix('B', "B", 24);
					killNotesLag.animation.addByPrefix('C', "C", 24);
					killNotesLag.animation.addByPrefix('D', "D", 24);
					killNotesLag.animation.addByPrefix('E', "E", 24);
					killNotesLag.animation.addByPrefix('F', "F", 24);
					killNotesLag.animation.addByPrefix('G', "G", 24);
					killNotesLag.animation.addByPrefix('H', "H", 24);
					killNotesLag.animation.addByPrefix('I', "I", 24);
			...
			case 'triple':
			{
					...
					var sSKY:FlxSprite = new FlxSprite(-621.1, -395.65).loadGraphic(Paths.image('weeb/Glitch'));
					...
					p3staticbg.frames = Paths.getSparrowAtlas('weeb/NewTitleMenuBG');
					p3staticbg.animation.addByPrefix('P3Static', 'TitleMenuSSBG instance', 24, true);
					p3staticbg.animation.play('P3Static');
					p3staticbg.screenCenter();
					p3staticbg.antialiasing = ClientPrefs.globalAntialiasing;
					p3staticbg.scale.x = 4.5;
					p3staticbg.scale.y = 4.5;
					p3staticbg.visible = false;
					add(p3staticbg);

					var busCapa0:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/triple park capa 3'));
					busCapa0.setGraphicSize(Std.int(busCapa0.width * 0.9));
					busCapa0.updateHitbox();
					busCapa0.screenCenter(X);
					busCapa0.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa1:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/triple park capa 2'));
					busCapa1.setGraphicSize(Std.int(busCapa1.width * 0.9));
					busCapa1.updateHitbox();
					busCapa1.screenCenter(X);
					busCapa1.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa2:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/triple park capa 1'));
					busCapa2.setGraphicSize(Std.int(busCapa2.width * 0.9));
					busCapa2.updateHitbox();
					busCapa2.screenCenter(X);
					busCapa2.antialiasing = ClientPrefs.globalAntialiasing;
					...
					var busCapa3:FlxSprite = new FlxSprite(0, -150).loadGraphic(Paths.image('weeb/triple park capa 0'));
					busCapa3.setGraphicSize(Std.int(busCapa3.width * 0.9));
					busCapa3.updateHitbox();
					busCapa3.screenCenter(X);
					busCapa3.antialiasing = ClientPrefs.globalAntialiasing;
					...
					bgspec.antialiasing = ClientPrefs.globalAntialiasing;
					...
					daP3Static = new FlxSprite(0, 0);
					daP3Static.frames = Paths.getSparrowAtlas('weeb/Phase3Static');
					daP3Static.animation.addByPrefix('idle', 'Phase3Static instance', 24, false);
					daP3Static.setGraphicSize(FlxG.width, FlxG.height);
					daP3Static.animation.play('idle');

					daNoteStatic = new FlxSprite(0, 0);
					daNoteStatic.frames = Paths.getSparrowAtlas('weeb/hitStatic');
					...
					balling = new FlxSprite(0, 0);
					balling.frames = Paths.getSparrowAtlas('weeb/daSTAT');
					...
					kyleJumpScare = new FlxSprite(0, 0).loadGraphic(Paths.image('weeb/KyleScreamer'));
					kyleJumpScare.antialiasing = ClientPrefs.globalAntialiasing;
					kyleJumpScare.setGraphicSize(FlxG.width, FlxG.height);
					kyleJumpScare.scrollFactor.set(0.95, 0.95);
					kyleJumpScare.screenCenter();

					stanJumpScare = new FlxSprite(0, 0).loadGraphic(Paths.image('weeb/StanScreamer'));
					stanJumpScare.antialiasing = ClientPrefs.globalAntialiasing;
					stanJumpScare.setGraphicSize(FlxG.width, FlxG.height);
					stanJumpScare.scrollFactor.set(0.95, 0.95);
					stanJumpScare.screenCenter();

					kennyJumpScare = new FlxSprite(0, 0).loadGraphic(Paths.image('weeb/KennyScreamer'));
					kennyJumpScare.antialiasing = ClientPrefs.globalAntialiasing;
					kennyJumpScare.setGraphicSize(FlxG.width, FlxG.height);
					kennyJumpScare.scrollFactor.set(0.95, 0.95);
					kennyJumpScare.screenCenter();

					dad = new Character(0, 0, 'Xenophane Sonic');
					add(dad);
					remove(dad);

					dad = new Character(0, 0, 'Knuckles exe');
					add(dad);
					remove(dad);

					dad = new Character(0, 0, 'kenny');
					add(dad);
					remove(dad);

					dad = new Character(0, 0, 'Tails exe');
					add(dad);
					remove(dad);
		...
		if (FlxG.save.data.snow)	//this code is from vs Ace. PD: don't use the same video.
		{
			...
			{
				case 'hot-dog':
					snowfallVid = new WebmIoFile(Paths.fideo('snowfalling1', 'preload'));
				case 'nugget':
					snowfallVid = new WebmIoFile(Paths.fideo('snowfalling2', 'preload'));
				case 'burger':
					snowfallVid = new WebmIoFile(Paths.fideo('snowfalling2', 'preload'));
				default:
					snowfallVid = new WebmIoFile(Paths.fideo('nada', 'preload'));
			}
			snowfall = new WebmPlayer();
			snowfall.fuck(snowfallVid, false);
			snowfallSpr = new FlxSprite().loadGraphic(snowfall.bitmapData);
			snowfallSpr.scale.set(1.6, 1.6);
			snowfallSpr.screenCenter(X);
			snowfallSpr.screenCenter(Y);
		...
		if (curSong.toLowerCase() == 'triple-park')
		{
			FlxG.camera.follow(camFollowPos, LOCKON, 0.1);
		...
		else if (curSong.toLowerCase() == 'pizza')
		{
			FlxG.camera.follow(camFollowPos, LOCKON, 0.1);
		}
		else
		...
		if (isRing)
		{
			...
			{
				ringCounter = new FlxSprite(1123, 30).loadGraphic(Paths.image('Counter'));
				ringCounter.setGraphicSize(Std.int(ringCounter.width * 1));
				ringCounter.antialiasing = true;
				add(ringCounter);
				ringCounter.cameras = [camHUD];

				counterNum = new FlxText(1197, 36, 0, '0', 10, false);
			...
			{
				ringCounter = new FlxSprite(1123, 610).loadGraphic(Paths.image('Counter'));
				ringCounter.setGraphicSize(Std.int(ringCounter.width * 1));
				ringCounter.antialiasing = true;
				add(ringCounter);
				ringCounter.cameras = [camHUD];

				counterNum = new FlxText(1197, 606, 0, '0', 10, false);
				counterNum.setFormat('EurostileTBla', 60, FlxColor.fromRGB(255, 204, 51), FlxTextBorderStyle.OUTLINE, FlxColor.fromRGB(204, 102, 0));
				counterNum.setBorderStyle(OUTLINE, FlxColor.fromRGB(204, 102, 0), 3, 1);
				add(counterNum);
				counterNum.cameras = [camHUD];
		...
		if (FlxG.save.data.snow && curSong == 'nugget')
		{
			add(snowfallSpr);
			snowfallSpr.cameras = [camHUD];
			snowfall.changePlaying(false);
		...
		if (FlxG.save.data.snow && curSong == 'burger')
		{
			add(snowfallSpr);
			snowfallSpr.cameras = [camHUD];
			snowfall.changePlaying(false);
		...
		{
			add(lluvia);
			lluvia.cameras = [camHUD];
		}

		if (FlxG.save.data.rain && curSong == 'pizza-old')
		{
			add(lluvia);
			lluvia.cameras = [camHUD];
		}

		if (FlxG.save.data.fog && curSong == 'southpurgation')
		{
			add(nieblaHUD);
			nieblaHUD.cameras = [camHUD];
		}

		if (curSong == 'triple-park')
		{
			kyleJumpScare.cameras = [camHUD];
			stanJumpScare.cameras = [camHUD];
			kennyJumpScare.cameras = [camHUD];
		}
		...
		if (isStoryMode && !seenCutscene)
		{
			switch (daSong)
			{
				...
				case 'chips':
					...
					FlxG.sound.play(Paths.sound('south1'));
				...
				case 'hot-dog':
					FlxG.camera.flash(FlxColor.BLACK, 3);
					FlxG.sound.play(Paths.sound('south2'));
					new FlxTimer().start(3, function(tmr:FlxTimer)
					{
						startDialogue(dialogueJson);
					});
				...
				case 'nugget':
					FlxG.camera.flash(FlxColor.BLACK, 3);
					FlxG.sound.play(Paths.sound('south3'));
					new FlxTimer().start(3, function(tmr:FlxTimer)
					{
						startDialogue(dialogueJson);
					});
				...
				case 'burger':
					FlxG.camera.flash(FlxColor.BLACK, 3);
					FlxG.sound.play(Paths.sound('south4'));
					new FlxTimer().start(3, function(tmr:FlxTimer)
					{
						startDialogue(dialogueJson);
					});
	...
	{		
		...
		daSign.frames = Paths.getSparrowAtlas('weeb/Sign_Post_Mechanic');

		daSign.setGraphicSize(Std.int(daSign.width * 0.67));

		daSign.antialiasing = ClientPrefs.globalAntialiasing;
		...
		daSign.animation.finishCallback = function(name)
		{
			daSign.alpha = 0;
			trace('ended sign');
			remove(daSign);
	...
	public function startCountdown():Void
	{
		...
		if(ret != FunkinLua.Function_Stop) {
			...
			if (curSong == 'triple-park')
			{
				...
				{
					opponentStrums.members[0].x += 31;
					opponentStrums.members[1].x += 34;
					opponentStrums.members[2].x += 37;
					opponentStrums.members[4].x -= 37;
					opponentStrums.members[5].x -= 34;
					opponentStrums.members[6].x -= 31;
					opponentStrums.members[3].visible = false;
				}
				...
				{
					opponentStrums.members[0].x += 40;
					opponentStrums.members[1].x += 45;
					opponentStrums.members[3].x -= 45;
					opponentStrums.members[4].x -= 40;
					opponentStrums.members[2].visible = false;
				}
			}
	...
	private function generateStaticArrows(player:Int):Void
	{
		for (i in 0...Main.ammo[mania])
		{
			...
			switch (curStage)
			{
				...
				default:
					var skin:String = SONG.arrowSkin;
	...
	override public function update(elapsed:Float)
	{
		...
		if (curSong == 'chips' && curStep != stepOfLast)
		{
			switch (curStep)
			{
				case 704:
					FlxTween.tween(FlxG.camera, {zoom: 1.1}, 3, {ease: FlxEase.linear});
					defaultCamZoom = 1.1;
				case 828:
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 1, {ease: FlxEase.linear});
					defaultCamZoom = 0.85;
				case 832:
		...
		if (curSong == 'nugget' && curStep != stepOfLast)
		{
			switch (curStep)
			{
				case 1:
		...
		if (curSong == 'pizza' && curStep != stepOfLast)
		{
			switch (curStep)
			{
				...
				case 2719:
					...
					add(lluvia);
				case 3248:
					FlxG.sound.play(Paths.sound('rayo'));
					FlxG.camera.flash(FlxColor.WHITE, 0.3);
					estruendo = false;
			}
		} 

		if (curSong == 'pizza-old' && curStep != stepOfLast)
		{
			switch (curStep)
			{
				case 2432:
					FlxG.camera.flash(FlxColor.WHITE, 1.3);
					FlxG.camera.shake(0.005, 34);
					remove(lluvia);
					remove(techoSky1);
					remove(techoClouds1);
					remove(techoPosts);
		...
		if (generatedMusic)
		{
			...
			notes.forEachAlive(function(daNote:Note)
			{
				...
				if (ClientPrefs.downScroll) {
					...
					daNote.x = (strumX + 0 * (Conductor.songPosition - daNote.strumTime) * roundedSpeed);
					...
					if (daNote.isSustainNote && daNote.y + daNote.offset.y * daNote.scale.y <= 0 && (!daNote.mustPress || (daNote.wasGoodHit || (daNote.prevNote.wasGoodHit && !daNote.canBeHit))))
				...
				else if (daNote.animation.curAnim.name.endsWith('hold')) {
					daNote.x += 36;
				}
				...
				if (!daNote.mustPress && daNote.wasGoodHit && !daNote.ignoreNote)
				{
					...
					if(!daNote.signsNote && !daNote.noAnimNote)
					{
								...
								{	
									case 0: //normal
									{
										if(storyDifficulty == 0)
										{
											...
											callOnLuas('noteMiss', [daNote.noteData, daNote.noteType, daNote]);
										}
									...
									case 4: //static notes
									{
										...
										{
											daNoteStatic.animation.play('stop');
										});
										health -= 0.15;
										combo = 0;
										vocals.volume = 0;
	...
	private function popUpScore(note:Note = null):Void
	{
		...
		if (FlxG.save.data.noteSpaches)	//this code is from Vs Momi.	//It is modified to work with 5k and 7k in Psych Engine
		{
			...
			var tex2:flixel.graphics.frames.FlxAtlasFrames = Paths.getSparrowAtlas('NOTE_splashes_Mysterion', 'preload');
			var tex3:flixel.graphics.frames.FlxAtlasFrames = Paths.getSparrowAtlas('NOTE_splashes_Blood', 'preload');

			switch(SONG.song)
			{
				case 'pizza' | 'pizza-old':
					sploosh.frames = tex2;
				case 'triple-park':
					sploosh.frames = tex3;
				default:
			...
			{
				case 1:
					sploosh.animation.addByPrefix('splash 0 0', 'note splash E 1', 24, false);
					sploosh.animation.addByPrefix('splash 1 0', 'note splash E 2', 24, false);
				case 2:
					sploosh.animation.addByPrefix('splash 0 0', 'note splash A 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 1', 'note splash B 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 2', 'note splash E 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 3', 'note splash C 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 4', 'note splash D 1', 24, false);
					sploosh.animation.addByPrefix('splash 1 0', 'note splash A 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 1', 'note splash B 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 2', 'note splash E 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 3', 'note splash C 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 4', 'note splash D 2', 24, false);
				case 3:
					sploosh.animation.addByPrefix('splash 0 0', 'note splash A 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 1', 'note splash C 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 2', 'note splash D 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 3', 'note splash E 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 4', 'note splash F 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 5', 'note splash G 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 6', 'note splash I 1', 24, false);
					sploosh.animation.addByPrefix('splash 1 0', 'note splash A 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 1', 'note splash C 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 2', 'note splash D 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 3', 'note splash E 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 4', 'note splash F 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 5', 'note splash G 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 6', 'note splash I 2', 24, false);
				default:
					sploosh.animation.addByPrefix('splash 0 0', 'note splash A 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 1', 'note splash B 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 2', 'note splash C 1', 24, false);
					sploosh.animation.addByPrefix('splash 0 3', 'note splash D 1', 24, false);
					sploosh.animation.addByPrefix('splash 1 0', 'note splash A 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 1', 'note splash B 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 2', 'note splash C 2', 24, false);
					sploosh.animation.addByPrefix('splash 1 3', 'note splash D 2', 24, false);
			}
	...
	function goodNoteHit(note:Note):Void
	{
		...
		if (!note.wasGoodHit)
		{
			if (note.mysteryNotes)
			{
				if(cpuControlled) return;

				ninetyHealth();
			}
			else if (note.killNotes)
			{
				if(cpuControlled) return;

				Healthf();
			}
			else if (note.staticNote)
			{
				if (cNum == 0)
					health -= 0;
				health += 0.023;
			}
			else if (note.phantomNote)
			{
				var fuckyou:Int = 0;
				if(cpuControlled) return;
				heatlhDrop += 0.00025;
			...
			else if(!note.signsNote && !note.noAnimNote)
			{
				var daAlt = '';
	...
	function ninetyHealth():Void
	{
		FlxG.sound.play(Paths.sound("bear"), 1);
		FlxG.camera.zoom -= 0.02;
		health -= FlxG.random.float(0.3, 0.9); 
	}

	function Healthf():Void
	{
	...
	function nukBoom():Void
	{
		...
		FlxG.camera.flash(FlxColor.RED, 1.3);
		FlxG.camera.shake(0.01, 2);
     	health -= 0.50;
	}

	function snowBall():Void
	{	
		snow.cameras = [camHUD];
		add(snow);
		...
		{
			FlxTween.tween(snow, {alpha: 0.65}, 0.23);
		});
		snow.animation.play('idle');
		new FlxTimer().start(1.0, function(tmr:FlxTimer)
		{
			snow.animation.play('stop');
		});
	}

	function staticHitMiss():Void
	{
		...
		FlxG.sound.play(Paths.soundRandom('hitStatic', 1, 2));

		add(daNoteStatic);

		new FlxTimer().start(.38, function(tmr:FlxTimer) // fixed lmao
		{
	...
	function doP3Static()
	{
		...
		daP3Static.animation.finishCallback = function(name)
		{
			daP3Static.alpha = 0;
	...
	function reverseArrows():Void
	{
		...
		{
			if (!FlxG.save.data.midscroll)
				FlxTween.tween(spr, {x: spr.x -= 650, y: spr.y}, 3, {ease: FlxEase.quartOut});
		});
	}

	function arrowsCannon():Void
	{
		opponentStrums.forEachAlive(function(spr:StrumNote)
		{
			if (!FlxG.save.data.midscroll)
	...
	function kyleScramer():Void
	{
		...
		new FlxTimer().start(0.2, function(tmr:FlxTimer)
		{
			...
			kyleJumpScare.alpha = 0;
			remove(kyleJumpScare);
		});
		...
		balling.animation.finishCallback = function(name)
		{
			trace('ended static');
			remove(balling);
		}
	...
	function stanScreamer()
	{
		...
		{
			trace('ended simple jump');
			stanJumpScare.alpha = 0;
			remove(stanJumpScare);
		});
	...
	function kennyScreamer()
	{
		...
		{
			trace('ended simple jump');
			kennyJumpScare.alpha = 0;
			remove(kennyJumpScare);
		});
	...
	{	
		...
		new FlxTimer().start(0.43, function(tmr:FlxTimer)
		{
			FlxTween.tween(shit, {alpha: 0.65}, 0.23);
		});
		shit.animation.play('idle');
		new FlxTimer().start(1.0, function(tmr:FlxTimer)
		{
			shit.animation.play('stop');
		});
	}
	...
	function bop(satan:FlxSprite):Void {
		bop1 = FlxTween.tween(satan, {y: -170}, 3, {
			ease: FlxEase.quadInOut,
			onComplete: function(tween:FlxTween)
			{
				bop2 = FlxTween.tween(satan, {y: -230}, 3, {
					ease: FlxEase.quadInOut,
					onComplete: function(tween:FlxTween)
					{
							bop(satan);
	...
	function rayosLocosLol():Void
	{
		FlxG.sound.play(Paths.soundRandom('thunder_', 1, 2));
		FlxG.camera.flash(FlxColor.WHITE, 0.3);

		rayosLocos = curBeat;
		rayosOffset = FlxG.random.int(8, 24);
		...
		if (curSong.toLowerCase() == 'triple-park')
		{
			switch (curStep)
			{
				...
				case 1040: // switch to sonic facing right
					...
					FlxTween.tween(FlxG.camera, {zoom: 0.85}, 2, {ease: FlxEase.cubeOut});
					defaultCamZoom = 0.85;
	...
	var rayosLocos:Int = 0;
	var rayosOffset:Int = 8;
	...
	override function beatHit()
	{
		...
		else if (estruendo && FlxG.random.bool(10) && curBeat > rayosLocos + rayosOffset)
		{
			rayosLocosLol();
		}
		lastBeatHit = curBeat;
